...
export const SingleChoiceEditorComponent: React.FC<NodeViewProps> = ({
                                                                     node,
                                                                     updateAttributes,
                                                                     editor,
                                                                 }) => {
    ...
    editor.state.doc.descendants((n: any) => {
        if (n.type.name === 'singleChoice' && Array.isArray(n.attrs.allGroups)) {
    ...
    const updateAllSingleChoiceGroups = (newGroupList: string[]) => {
    ...
    const handleAddGroup = () => {
        ...
        updateAllSingleChoiceGroups(newGroupList)
    ...
    return (
        <NodeViewWrapper
            ...
            data-group={groupId || ''}>
            <input type="radio" disabled className="w-5 h-5 cursor-not-allowed" style={{ flexShrink: 0 }}/>
